...
const AdminLogin = () => {
  ...
  const handleSubmit = (e) => {
    ...
    setCurrentUser({
      name: displayName.charAt(0).toUpperCase() + displayName.slice(1) || 'Admin',
      email: email,
      role: 'admin',
    })
      ...
      <div className="card relative z-10 w-full max-w-md overflow-hidden rounded-3xl border border-white/10 bg-white/10 shadow-2xl backdrop-blur-xl">
        ...
        <div className="p-8 sm:p-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center gap-2 text-gray-400 cursor-pointer">
                <input type="checkbox" className="accent-emerald-500 h-4 w-4 rounded" />
                Remember me
              </label>
          ...
          <p className="mt-8 text-center text-sm text-gray-400">
            ...
            <a href="/admin/signup" className="font-semibold text-emerald-400 hover:text-emerald-300 transition">
              Sign Up
            </a>
          </p>
